...
if ( ! class_exists( 'Thim_Core_Installer' ) ) {
	...
	class Thim_Core_Installer {
		...
		private $theme = array(
			'name'    => 'edu-press',
			'slug'    => 'edu-press',
			'support' => 'https://thimpress.com/forums/forum/tutorx/'
		);
		...
		private function setup_environments() {
			...
			<table class="widefat striped" cellspacing="0">
				...
				<tr>
					...
					<td>
						...
						if ( version_compare( $args['php_version'], '5.6', '<' ) ) {
							...
							echo '<mark class="error"><span class="dashicons dashicons-warning"></span> ' . sprintf( __( '%1$s - We recommend a minimum PHP version of 5.6. See: %2$s', 'edu-press' ), esc_html( $args['php_version'] ), '<a href="' . $php_version_link . '" target="_blank">' . esc_attr__( 'How to update your PHP version', 'edu-press' ) . '</a>' ) . '</mark>';
						} else {
				...
				<tr>
					<td><?php echo esc_html__( 'Remote GET', 'edu-press' ); ?></td>
					<td><?php
						if ( $args['remote_get_successful'] ) {
							echo '<mark class="yes"><span class="dashicons dashicons-yes"></span></mark>';
						} else {
							echo '<mark class="error"><span class="dashicons dashicons-warning"></span> ' . esc_attr__( 'wp_remote_get() failed. Please contact your hosting provider.', 'edu-press' ) . ' ' . esc_html( $args['remote_get_response'] ) . '</mark>';
						} ?>
					</td>
				</tr>
