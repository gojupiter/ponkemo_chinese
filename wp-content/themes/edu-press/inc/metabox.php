...
if ( ! function_exists( 'thim_add_metabox_settings' ) ) {
	function thim_add_metabox_settings( $meta_box, $prefix ) {
		...
		$meta_box['fields'] = array(
			...
			array(
				'name' => __( 'Hide Breadcrumbs', 'storepify' ),
			 ...
			 */
			array(
				'name' => __( 'Use Custom Layout', 'storepify' ),
			...
			array(
				'name'    => __( 'Select Layout', 'storepify' ),
				'id'      => $prefix . 'layout',
				'type'    => 'image_select',
				'options' => array(
			...
			array(
				'name' => __( 'No Padding Content', 'storepify' ),
